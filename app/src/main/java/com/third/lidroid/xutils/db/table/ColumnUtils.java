...
package com.third.lidroid.xutils.db.table;

import android.text.TextUtils;

import com.third.lidroid.xutils.db.annotation.*;
import com.third.lidroid.xutils.db.annotation.Column;
import com.third.lidroid.xutils.db.annotation.Finder;
import com.third.lidroid.xutils.db.annotation.Foreign;
import com.third.lidroid.xutils.db.annotation.Id;
import com.third.lidroid.xutils.db.converter.ColumnConverter;
import com.third.lidroid.xutils.db.converter.ColumnConverterFactory;
import com.third.lidroid.xutils.db.sqlite.FinderLazyLoader;
import com.third.lidroid.xutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.third.lidroid.xutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.third.lidroid.xutils.db.table.Finder finderColumn) {
