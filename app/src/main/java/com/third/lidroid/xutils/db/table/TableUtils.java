...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.third.lidroid.xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.third.lidroid.xutils.db.table.Id>();

    /* package */
    static synchronized com.third.lidroid.xutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.third.lidroid.xutils.db.table.Id id = new com.third.lidroid.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.third.lidroid.xutils.db.table.Id id = getId(entityType);
